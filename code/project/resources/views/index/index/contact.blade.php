        ...
        <div class="container">
            <div class="fl">
                ...
                <div class="category clearfix">
                    <h3><span class="iconfont icon-jiantou"></span><a href="/about.html">公司介绍</a></h3>
                    <h3 class="on"><span class="iconfont icon-jiantou"></span><a href="">联系我们</a></h3>
                </div>
                <div class="contact">
                    <p>全国服务热线</p>
                    <span>
            ...
            <div class="fr">
                <div class="title"><span>联系我们</span>
                    <p>您的位置：<a href="/">首页</a>><a href="">联系我们</a></p>
                </div>
                <div class="news">
                    <div class="info">
                        ...
                        <script type="text/javascript" src="{{ $staticUrl }}js/api.js"></script>
                        <div style=" width:100%; margin-top:2px;height:400px; margin-left:0px; " id="allmap">
                            <script type="text/javascript">
                                // 百度地图API功能
                                var sContent = "<p>公司名称：@if(!empty($platformInfo['name'])) {{$platformInfo['name']}} @endif</p><p>销售经理：@if(!empty($platformInfo['contact_name'])) {{$platformInfo['contact_name']}} @endif</p><p>联系座机：@if(!empty($platformInfo['telephone'])) {{$platformInfo['telephone']}} @endif</p><p>联系电话：@if(!empty($platformInfo['phone'])) {{$platformInfo['phone']}} @endif</p><p>QQ: @if(!empty($platformInfo['qq'])) {{$platformInfo['qq']}} @endif</p><p>邮箱：@if(!empty($platformInfo['email'])) {{$platformInfo['email']}} @endif</p><p>公司地址：@if(!empty($platformInfo['address'])) {{$platformInfo['address']}} @endif</p><p>微信：@if(!empty($platformInfo['wechat'])) {{$platformInfo['wechat']}} @endif</p>" +
                                    "</div>";
                        ...
                        @if(!empty($platformInfo['address2']) && !empty($platformInfo['address2_longitude']) && !empty($platformInfo['address2_latitude']))
                        <br />
                        <div style=" width:100%; margin-top:2px;height:400px; margin-left:0px; " id="allmap2">
                            <script type="text/javascript">
                                // 百度地图API功能
                                var sContent = "<p>公司名称：@if(!empty($platformInfo['name'])) {{$platformInfo['name']}} @endif</p><p>销售经理：@if(!empty($platformInfo['contact_name'])) {{$platformInfo['contact_name']}} @endif</p><p>联系座机：@if(!empty($platformInfo['telephone'])) {{$platformInfo['telephone']}} @endif</p><p>联系电话：@if(!empty($platformInfo['phone'])) {{$platformInfo['phone']}} @endif</p><p>QQ: @if(!empty($platformInfo['qq'])) {{$platformInfo['qq']}} @endif</p><p>邮箱：@if(!empty($platformInfo['email'])) {{$platformInfo['email']}} @endif</p><p>公司地址：@if(!empty($platformInfo['address2'])) {{$platformInfo['address2']}} @endif</p><p>微信：@if(!empty($platformInfo['wechat'])) {{$platformInfo['wechat']}} @endif</p>" +
                                    "</div>";
                                ...
                                map.addControl(new BMap.NavigationControl({anchor: BMAP_ANCHOR_BOTTOM_LEFT, type: BMAP_NAVIGATION_CONTROL_PAN}));  //左下角，仅包含平移按钮
                                map.addControl(new BMap.NavigationControl({anchor: BMAP_ANCHOR_BOTTOM_RIGHT, type: BMAP_NAVIGATION_CONTROL_ZOOM}));  //右下角，仅包含缩放按钮
                                var point = new BMap.Point( @if(!empty($platformInfo['address2_longitude'])) {{$platformInfo['address2_longitude']}} @endif , @if(!empty($platformInfo['address2_latitude'])) {{$platformInfo['address2_latitude']}} @endif ); //113.283672|22.834463
                                var marker = new BMap.Marker(point);
                                var infoWindow = new BMap.InfoWindow(sContent);  // 创建信息窗口对象
                                map.centerAndZoom(point, 15);
                                map.addOverlay(marker);
