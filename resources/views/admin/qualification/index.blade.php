                ...
                <form class="layui-form layui-form-pane" action="">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            <label class="layui-form-label">资质分类</label>
...
<script>
    layui.use(['form', 'table', 'tableSelect'], function () {
        ...
        table.render({
            elem: '#currentTableId',
            url: '/admin/qualification/getQualificationList?_token={{ csrf_token() }}',
            method: 'post',
            toolbar: '#toolbarDemo',
            defaultToolbar: ['filter'],
            cols: [[
                {type: "checkbox", width: 50},
                {field: 'category_name', minWidth: 120, title: '资质分类'},
                {field: 'name', minWidth: 120, title: '名称'},
                {
                    field: 'img', width: 150, title: '图片', align: 'center', templet: function (d) {
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {
            if (obj.event === 'add') {   // 监听添加操作
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['100%', '100%'],
                    content: '/admin/qualification/edit',
                });
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['100%', '100%'],
                    content: '/admin/qualification/edit?qualification_id=' + data.qualification_id,
                });
                $(window).on("resize", function () {
                    layer.full(index);
                });
                ...
                $.ajax({
                    url: "/admin/qualification/setQualificationStatus?_token={{ csrf_token() }}",
                    type: "post",
                    dataType: "json",
                    data: {
